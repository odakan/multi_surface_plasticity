...
// Constructor
//================================================================================
vonMises_yield_surface::vonMises_yield_surface( 
        int tag,
        double E_in,
        double v_in,
        double rho_in,
    ...
    MultiYieldSurfaceMaterial( 
            tag, 
            0, //ND_TAG_vonMises_yield_surface, 
            E_in, 
            v_in, 
            rho_in, 
            TNYS_in, 
...
// ================================================================================
DTensor2 vonMises_yield_surface::df_dsigma(int N_active_ys, DTensor2 const& stress){
    if (N_active_ys > TNYS )
    {
        cerr<< "vonMises_yield_surface::df_dsigma " <<endl;
...
// ================================================================================
DTensor2 vonMises_yield_surface::df_dalpha(int N_active_ys, DTensor2 const& stress){
    if (N_active_ys > TNYS )
    {
        cerr<< "vonMises_yield_surface::df_dalpha " <<endl;
...
// ================================================================================
DTensor2 vonMises_yield_surface::plastic_flow_direct(DTensor2 const& nn, DTensor2 const& stress, int N_active_ys ){
...
// ================================================================================
DTensor2 vonMises_yield_surface::alpha_bar(int N_active_ys, DTensor2 const& stress){
    ...
    if(curr_radius == 0){
        cerr<< "vonMises_yield_surface::alpha_bar " <<endl;
...
// ================================================================================
double vonMises_yield_surface::yield_surface_val(DTensor2 const& stress, DTensor2 const& alpha, double radius){
...
// //================================================================================
// DTensor2 const& vonMises_yield_surface::getTangent(void){
//     // double mu2 = E / (1.0 + v);
...
//================================================================================
void vonMises_yield_surface::update_modulus( int N_active_ys, DTensor2 const& s )
{
    Ee *= 0;
    // =========================================================
...
DTensor4 const& vonMises_yield_surface::getTangentTensor()
{
...
void vonMises_yield_surface::compute_elastoplastic_tangent(int N_active_ys, DTensor2 const& intersection_stress, bool elastic){
    ...
    // if (denominator == 0 ){
    //     cerr<< "vonMises_yield_surface::compute_elastoplastic_tangent()" <<endl;
...
//================================================================================
vonMises_yield_surface *vonMises_yield_surface::getCopy( void ){
    vonMises_yield_surface *tmp = new vonMises_yield_surface( 
            1, //this->getTag(),
            this->getE(),
            this->getv(),
            this->getRho(),
...
//================================================================================
const char *vonMises_yield_surface::getType( void ) const
{
    return "vonMises_yield_surface";
}

// //================================================================================
// // Message passing for parallel
// //================================================================================
// int vonMises_yield_surface::sendSelf( int commitTag, Channel &theChannel )
// {
//     cerr<<"vonMises_yield_surface::sendSelf() is not implemented yet! " <<endl;
//     ID idData(1);
//     Vector vectorData(6);
//     Matrix a(3, 3);
...
//     {
//         cerr << "vonMises_yield_surface::sendSelf -- could not send idData\n";
//         return -1;
//     }
...
//     {
//         cerr << "vonMises_yield_surface::sendSelf -- could not send vectorData\n";
//         return -1;
//     }
...
//     {
//         cerr << "vonMises_yield_surface::sendSelf -- could not send multi_ys_data\n";
//         return -1;
//     }
...
//     {
//         cerr << "vonMises_yield_surface::sendSelf -- could not send converge_commit_stress\n";
//         return -1;
//     }
...
//     if (theChannel.sendMatrix(0, 0, a) < 0)
//     {
//         cerr << "vonMises_yield_surface::sendSelf -- could not send converge_commit_strain\n";
//         return -1;
//     }
...
//     if (theChannel.sendMatrix(0, 0, a) < 0)
//     {
//         cerr << "vonMises_yield_surface::sendSelf -- could not send converge_commit_plastic_strain\n";
//         return -1;
//     }
...
//         if (theChannel.sendMatrix(0, 0, a) < 0)
//         {
//             cerr << "vonMises_yield_surface::sendSelf -- could not send converge_commit_alpha_vec\n";
//             return -1;
//         }
//     }
...
// // Message passing for parallel
// //================================================================================
// int vonMises_yield_surface::receiveSelf( int commitTag, Channel &theChannel, FEM_ObjectBroker &theBroker )
// {
//     cerr<<"vonMises_yield_surface::receiveSelf() is not implemented yet! " <<endl;
//     ID idData(1);
//     Vector vectorData(6);
//     Matrix a(3, 3);
...
//     {
//         cerr << "vonMises_yield_surface::receiveSelf -- could not receive idData\n";
//         return -1;
//     }
...
//     {
//         cerr << "vonMises_yield_surface::receiveSelf -- could not receive vectorData\n";
//         return -1;
//     }
...
//     {
//         cerr << "vonMises_yield_surface::receiveSelf -- could not receive Elastic Constant strain\n";
//         return -1;
//     }
...
//     if (theChannel.receiveMatrix(0, 0, a) < 0)
//     {
//         cerr << "vonMises_yield_surface::receiveSelf -- could not receive Elastic Constant Tensor\n";
//         return -1;
//     }
...
//================================================================================
void vonMises_yield_surface::Print( ostream &s, int flag )
{
    s << "vonMises_yield_surface::" << endl;
