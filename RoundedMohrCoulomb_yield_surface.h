...
*****************************************************************************************************************/
#ifndef RoundedMohrCoulomb_yield_surface_H
#define RoundedMohrCoulomb_yield_surface_H
...
class RoundedMohrCoulomb_yield_surface : public MultiYieldSurfaceMaterial
{
public:
    RoundedMohrCoulomb_yield_surface( 
        int tag,
        double E_in,
        double v_in,
        double rho_in,
    ...
    RoundedMohrCoulomb_yield_surface();                     // Empty Constructor for Parallel
    virtual ~RoundedMohrCoulomb_yield_surface( void );      // Destructor
    ...
    RoundedMohrCoulomb_yield_surface *getCopy( void );
    ...
    virtual const char *getType( void ) const{return "RoundedMohrCoulomb_yield_surface";};
    virtual const char *getClassType( void ) const{return "RoundedMohrCoulomb_yield_surface";};
