...
#ifndef vonMises_yield_surface_H
#define vonMises_yield_surface_H
...
class vonMises_yield_surface : public MultiYieldSurfaceMaterial
{
public:
    vonMises_yield_surface( 
        int tag,
        double E_in,
        double v_in,
        double rho_in,
    ...
    vonMises_yield_surface();                               // Empty Constructor for Parallel
    virtual ~vonMises_yield_surface( void );                // Destructor


    virtual vonMises_yield_surface *getCopy( void );
    ...
    virtual const char *getClassType( void ) const{return "vonMises_yield_surface";};
